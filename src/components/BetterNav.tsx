...
export default function BetterNav ({
    ...
    return (
        <>
            ...
            <button onClick={() => toggleOpen(!isOpen)} className="sm:hidden relative my-2 flex flex-col justify-between w-[30px] h-4 z-50 focus:outline-none">
            ...
            `}>
                <ul className="space-y-10 text-center z-50 text-4xl">
                    <li>
                        <Link to="/" className={`${screen === 'home' ? 'underline underline-offset-4' : ''}`} onClick={() => toggleOpen(false)}>
                            home
                        </Link>
                    </li>
                    <li>
                        <Link to="/projects" className={`${screen === 'projects' ? 'underline underline-offset-4' : ''}`} onClick={() => toggleOpen(false)}>
                            projects
                        </Link>
                    </li>
                    <li>
                        <Link to="/about" className={`${screen === 'about' ? 'underline underline-offset-4' : ''}`} onClick={() => toggleOpen(false)}>
                            about
                        </Link>
                    </li>
                    <li>

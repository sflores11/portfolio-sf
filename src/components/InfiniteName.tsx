...
export default function InfinateName () {
    ...
    return (
        <div className="h-auto ml-5 mr-6 font-impact select-none text-[#DFDFDF] text-[200px] sm:text-[275px] md:text-[325px] lg:text-[400px] xl:text-[500px] leading-[175px] sm:leading-[235px] md:leading-[280px] lg:leading-[355px] xl:leading-[445px] tracking-[-5px] overflow-hidden">
